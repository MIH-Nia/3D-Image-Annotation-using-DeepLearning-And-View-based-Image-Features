    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_loss < best_loss:
                ...
                torch.save(model.state_dict(), 'C:/Users/mh661/Desktop/multi_labels-multi_view_10_classes/models/mobilenet_v3_large_cpk/mobilenet_v3_large-{}.ckpt'.format(epoch + 1))
...
if __name__ == "__main__":
    ...
    #model.load_state_dict(torch.load("C:/Users/mh661/Desktop/multi_labels-multi_view_10_classes/models/mobilenet_v3_large_cpk/mobilenet_v3_large-35.ckpt"))
    # fine_tune = True
    # if fine_tune:
    ...
    for param in model[0].features[2].block.parameters():
        param.requires_grad = True
    for param in model[0].features[3].block.parameters():
        param.requires_grad = True
    for param in model[0].classifier.parameters():
        param.requires_grad = True

    criterion = nn.BCELoss()
    optimizer_ft = optim.Adam(model.parameters(), lr=0.001 ,weight_decay=0.00001 ,betas=(0.9, 0.999))
    exp_lr_scheduler = lr_scheduler.StepLR(optimizer_ft, step_size=30, gamma=0.1)

    train_model(model, train_loader_m, val_loader_m, criterion, optimizer_ft, exp_lr_scheduler, num_epochs=15)
