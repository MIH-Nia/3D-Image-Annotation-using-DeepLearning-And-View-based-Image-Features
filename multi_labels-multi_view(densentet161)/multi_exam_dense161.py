...
if __name__ == "__main__":
    ...
    model_ft.features[0] = nn.Conv2d(num_views, 96, kernel_size=(7, 7), stride=(2, 2), padding=(3, 3), bias=False)
    num_ftrs = model_ft.classifier.in_features
    model_ft.classifier = nn.Linear(num_ftrs, number_of_tags)
    model = nn.Sequential(model_ft, nn.Sigmoid()).to(device)
    model.load_state_dict(torch.load("C:/Users/mh661/PycharmProjects/Image-Tagging-Model/models/densenet161-2.ckpt",
    ...
    with torch.no_grad():
        fig = plt.figure()
        train_dataset_m = MultiviewImgDataset(root_dir='C:/Users/mh661/Desktop/final_mv_mtag/image_12/bench/test',
