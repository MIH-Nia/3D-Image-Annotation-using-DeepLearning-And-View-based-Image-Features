...
if __name__ == "__main__":
    ...
    model_ft.features[0] = nn.Conv2d(num_views, 24, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1), bias=False)
    num_ftrs = model_ft.classifier[1].in_features
    model_ft.classifier[1] = nn.Linear(num_ftrs, number_of_tags)
    model = nn.Sequential(model_ft, nn.Sigmoid()).to(device)


    model.load_state_dict(torch.load("C:/Users/mh661/PycharmProjects/Image-Tagging-Model/models/efficientnet_v2_s_cpk/efficientnet_v2_s-6.ckpt",
    ...
    with torch.no_grad():
        fig = plt.figure()
        train_dataset_m = MultiviewImgDataset(root_dir='C:/Users/mh661/Desktop/image_12/bench/test',
                                              scale_aug=False, rot_aug=False, test_mode=True, num_models=0,
