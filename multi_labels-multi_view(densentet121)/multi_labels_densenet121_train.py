    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_loss < best_loss:
                ...
                torch.save(model.state_dict(), 'C:/Users/mh661/Desktop/multi_labels-multi_view_10_classes/models/densenet121_cpk/densenet121-{}.ckpt'.format(epoch + 1))
...
if __name__ == "__main__":
    ...
    model_ft.features[0] = nn.Conv2d(num_view, 64, kernel_size=(7, 7), stride=(2, 2), padding=(3, 3), bias=False)
    num_ftrs = model_ft.classifier.in_features
    model_ft.classifier = nn.Linear(num_ftrs, number_of_tags)
    model = nn.Sequential(model_ft, nn.Sigmoid()).to(device)

    model.load_state_dict(torch.load("C:/Users/mh661/Desktop/multi_labels-multi_view_10_classes/models/densenet121_cpk/densenet121-best in 15 epochs.ckpt"))  # 0.7
   ...
   # weight = torch.FloatTensor(make_class_weights(root_dir1)).to(device)
    ...
    train_model(model, train_loader_m, val_loader_m, criterion, optimizer_ft, exp_lr_scheduler, num_epochs=5)